...
var transactions = localStorage.getItem('transactions') !== null ? localStorageTransactions : []; // let transactions = dummyTransction;
...
function addTransactionDOM(transaction) {
  ...
  item.innerHTML = "".concat(transaction.text, " <span>").concat(sign).concat(Math.abs(transaction.amount), "</span> <button class=\"delete-btn\" onclick=\"removeTransaction(").concat(transaction.id, ")\">x</button>");
...
function updateValues() {
  ...
  Balance.innerText = "RS.".concat(total);
  money_plus.innerText = "RS.".concat(income);
  money_minus.innerText = "RS.".concat(expense);
